  ...
  return (
    <div className='bg-richblack-800'>
      ...
      text-richblack-400 border-b border-richblack-700 mx-auto py-14 leading-6'>
        {/* left section */}
        <div className='lg:w-[50%] flex flex-row justify-between flex-wrap lg:border-r lg:border-richblack-700 gap-y-5 gap-3 pl-3 lg:pr-5 pt-7'>
          {/* column 1 */}
          <div className='w-[48%] lg:w-[30%] flex flex-col gap-2' >
            <img src={Logo} alt="StudyNotion logo" className='object-contain max-w-[250px]'/>
      ...
      {/* bottom */}
      <div className='w-11/12 max-w-maxContent mx-auto flex flex-row justify-between items-center flex-wrap text-richblack-400 pb-10 gap-3 mt-5'>
