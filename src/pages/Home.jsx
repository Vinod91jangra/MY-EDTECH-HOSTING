  ...
  return (
    <div>
        ...
        <div className='relative mx-auto max-w-maxContent flex flex-col w-11/12 items-center justify-between text-white '>
            ...
            {/* Button */}
            <div className="flex flex-row gap-7 mt-14">
            ...
            <div>
                <CodeBlocks
                    ...
                    codeColor={"text-[#F5D020]"}
                    backgroundGradient={"bg-gradient-to-br from-[#F53803] via-[#F5D020] to-[#EA2027]"}
                />
            </div>
            ...
            <div>
                <CodeBlocks
                    ...
                    backgroundGradient={"bg-gradient-to-r from-[#0CAFFF] via-[#00BFFF] to-[#0CAFFF]"}
                />
            </div>
        ...
        <div className='bg-pure-greys-5 text-richblack-500'>
            ...
            <div className='mx-auto w-11/12 max-w-maxContent flex flex-col items-center justify-between gap-7'>
                <div className='flex flex-col lg:flex-row justify-between gap-5 mb-10 mt-[-120px] lg:mt-[95px]'>
                    <div className='text-4xl font-semibold text-richblack-800 lg:w-[45%]'>
